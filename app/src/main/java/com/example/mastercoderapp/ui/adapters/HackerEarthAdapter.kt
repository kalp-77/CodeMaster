...
import com.example.mastercoderapp.ui.fragments.AtCoderFragment
import com.example.mastercoderapp.ui.fragments.HackerEarthFragment

class HackerEarthAdapter (private val context: HackerEarthFragment, private val articles: List<ContestDetailsItem>) : RecyclerView.Adapter<HackerEarthAdapter.ViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(context.requireContext()).inflate(R.layout.at_coder_layout, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.duration.text = "Duration: " + ((article.duration.toFloat()%86400) / 3600).toInt() + " hrs"
