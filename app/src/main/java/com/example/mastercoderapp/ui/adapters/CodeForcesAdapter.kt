...
import com.example.mastercoderapp.ui.fragments.CodeForcesFragment

class CodeForcesAdapter (private val context: CodeForcesFragment, private val articles: List<ContestDetailsItem>) : RecyclerView.Adapter<CodeForcesAdapter.ViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(context.requireContext()).inflate(R.layout.code_forces_layout, parent, false)
