...
import com.example.mastercoderapp.ui.fragments.TopCoderFragment

class TopCoderAdapter (private val context: TopCoderFragment, private val articles: List<ContestDetailsItem>) : RecyclerView.Adapter<TopCoderAdapter.ViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(context.requireContext()).inflate(R.layout.top_coder_layout, parent, false)
